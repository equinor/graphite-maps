...
$$
\alpha = \lVert z\rVert_2^2 - (X^\top z)^\top\tilde\beta.
$$
...
While the simplification of $\alpha$ is not strictly needed for the derivation, it provides a more efficient way to compute $\alpha$ in the implementation:
